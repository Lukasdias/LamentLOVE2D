...
local direcao 
  ...
  function Laurence_load(map, world)
	...
	laurence.fixture = love.physics.newFixture(laurence.body, laurence.shape, 1)
	-- Sprites Organizados--
	laurenceImg = {}
...
function last_keyreleased(key)
	...
	if key == "left" or "right" then
		laurence.body:setLinearVelocity(0, 0)
	end
end
